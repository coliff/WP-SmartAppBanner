...
add_action('login_head', 'set_ios_app_do');
add_action('admin_head', 'set_ios_app_do');
add_action('admin_menu', 'set_ios_app_menu');
function set_ios_app_do(){
echo '<link name="apple-itunes-app" content="app-id=' . get_option('set_ios_app_value') . '">';
}
...
echo '<p>iOS App ID: <input type="text" placeholder="e.g. 123456789" pattern="[0-9]{8,9}" inputmode="numeric" name="ios_app_value" maxlength="9" value="' . get_option('set_ios_app_value') . '" required /></p>';
